...
def update_gateway_sheet_with_xlwings(target_excel_path, sheet_name, df_updated):
    ...
    try:
        ...
        # 3.7 核减（匹配核减清单）- 整合test.py的核减清理功能
